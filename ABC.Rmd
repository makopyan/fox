...
priors$variable <- factor(priors$variable , levels = c("NeThree","TimeTwo","NeTwo","TimeOne","NeCurr"))

priors <- priors[order(priors$variable), ]
...
<details>
<summary>Get allele counts</summary>
<br>
```{bash alleles, eval=F}
...
<details>
<summary>Bin allele counts</summary>
<br>
```{r binAlleles, eval=F}
...
<details>
<summary>Calculate per-site nucleotide diversity</summary>
<br>
...
<details>
<summary>Calculate average per neutral region</summary>
<br>
```{bash sumPi, eval=F}
...
<details>
<summary>Bin nucleotide diversity</summary>
<br>
```{r pibin, eval=F}
