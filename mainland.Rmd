...
start with two vcf files, one for gray foxes and one for island foxes with variants called using the gray fox reference genome
...
<p>
```{bash, vcftools, eval=FALSE, include=TRUE}
#!/bin/sh
