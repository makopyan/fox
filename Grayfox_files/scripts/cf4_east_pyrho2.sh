#!/bin/sh
#SBATCH --job-name=cf4_east_pyrho2
#SBATCH --output=/scratch1/genchev/logfile/cf4_east_pyrho2_%a.out  
#SBATCH --error=/scratch1/genchev/logfile/cf4_east_pyrho2_%a.err
...
pyrho optimize --tablefile "/home1/genchev/canfam4_rmap/"$NAME".hdf" \
	--vcffile "/home1/genchev/split_vcf_n6/chr"$CHROM".east.cf4.vcf.gz"  \
	--outfile "/home1/genchev/canfam4_rmap/"$NAME"_"$CHROM".rmap" \
...
pyrho compute_r2 --quantiles .25,.5,.75 --compute_mean --samplesize $ne \
	--tablefile "/home1/genchev/canfam4_rmap/"$NAME".hdf" \
	--outfile "/home1/genchev/canfam4_rmap/"$NAME"_"$CHROM"_r2.tsv"
