#!/bin/sh
#SBATCH --job-name=cf4_west_pyrho2
#SBATCH --output=/scratch1/genchev/logfile/cf4_west_pyrho2_%a.out  
#SBATCH --error=/scratch1/genchev/logfile/cf4_west_pyrho2_%a.err
...
pyrho optimize --tablefile "/home1/genchev/canfam4_rmap/"$NAME".hdf" \
	--vcffile "/home1/genchev/split_vcf_n6/chr"$CHROM".west.cf4.vcf.gz"  \
