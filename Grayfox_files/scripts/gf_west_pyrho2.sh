#!/bin/sh
#SBATCH --job-name=gf_west_pyrho2
#SBATCH --output=/scratch1/genchev/logfile/gf_west_pyrho2_%a.out  
#SBATCH --error=/scratch1/genchev/logfile/gf_west_pyrho2_%a.err
...
pyrho optimize --tablefile "/home1/genchev/grayfox_rmap/"$NAME".hdf" \
	--vcffile "/home1/genchev/split_vcf_n6/chr"$CHROM".west.gf.vcf.gz"  \
