...
```{r segsites, warning=FALSE, message=FALSE, echo=FALSE, fig.height=5, fig.width = 6}
...
ggplot(nvar,aes(x=interaction(pop,genome), y=var, fill=pop)) +
  geom_col() + 
  geom_text(aes(y = var + 15000, label = var))+ 
  scale_fill_manual(values = c("#4d9aff", "#f2675f"))+
  theme_bw()+
  ylab("Variants")+
  theme(axis.title.x = element_blank(),
