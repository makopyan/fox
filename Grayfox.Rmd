...
### Arctic Fox
>Peng et al. (2021). Chromosome-level genome assembly of the Arctic fox (Vulpes lagopus) using PacBio sequencing and Hi-C technology, Molecular Ecology Resources, 21:2093–2108, https://doi.org/10.1111/1755-0998.13397


### Dog (CanFam4)
>Wang et al. (2021). A novel canine reference genome resolves genomic architecture and uncovers transcript complexity, Communications Biology, 4:185, https://doi.org/10.1038/s42003-021-01698-x
...
ggplot()+
  ...
  labs(x = bquote('Years'~(10^3)), y =  bquote('Effective Population Size'~(10^3)),tag="B)") +
...
```{r plot-sfs,warning=F, message=F, fig.height=3.5,  fig.width=5.5}
...
Liftover recombination rates in 50kb windows from heterospecific to conspecific genomes

```{bash liftover-recomb, eval=F}
...
Liftover outlier windows from heterospecific to conspecific genomes, and between heterospecific genomes
